...
namespace PearlBag
{
    class Pearl
    {
        ...
        {
            btn = new ExCirclePanel(_peralColor, false, _pearlSize);
        ...
        {
            btn = new ExCirclePanel(_peralColor, false, size);
            btn.Cursor = System.Windows.Forms.Cursors.Hand;
        ...
        {
            btn = new ExCirclePanel(color, false, size);
            btn.Cursor = System.Windows.Forms.Cursors.Hand;
