...
{
    public class ExButton : Button, IButtonSet
    {
        ...
        public ExButton(Color defaultColor, bool isEditable, Size size)
        {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            var brush = new LinearGradientBrush(rect, Color.Blue,Color.SkyBlue, 90);
