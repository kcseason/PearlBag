...
{
    public class ExTrianglePanel:Panel,IPanelSet
    {
        ...
        public ExTrianglePanel(ArrowDirection arrowDirect,Color color,bool isEditable)
        {
                ...
                case ArrowDirection.Up:
                    {
                        ...
                        ap = new AnchorPoint()
                        {
                            AnchorRec = new Rectangle(0, this.Height - AnchorPointRange , AnchorPointRange, AnchorPointRange),
                ...
                case ArrowDirection.Down:
                    {
                        AnchorPoint ap = new AnchorPoint()
                        {
                            AnchorRec = new Rectangle(this.Width / 2 - AnchorPointRange / 2, this.Height - AnchorPointRange, AnchorPointRange, AnchorPointRange),
                        ...
                        ap = new AnchorPoint()
                        {
                            AnchorRec = new Rectangle(this.Width - AnchorPointRange, 0, AnchorPointRange, AnchorPointRange),
                            AnchorDirect= MoveDirect.Right,
                        };
                        lstAnchorPoint.Add(ap);
                        break;
